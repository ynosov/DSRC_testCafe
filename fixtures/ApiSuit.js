...
import { getSession, getUserId, getUserInfo, createRfqSourcingEvent, startImportRfx, completeImportRfq, nextToStateSuppliers, sleep, logIn, createRfpSourcingEvent } from '../helpers/api-helpers';
...
test('Create RFQ Sourcing Event', async () => {
   ...
   // await createRfpSourcingEvent( sv.userInfo ).then( rfxDetails => sv.rfxDetails = rfxDetails);
